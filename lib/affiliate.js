// lib/affiliate.js
// Deep links for POI discovery and tour/experience affiliate partners.
// Affiliate IDs are optional environment variables; when absent, we fall
// through to the vendor's public URL.
...
// Curated POI category links for a neighborhood. All routed through Google Maps
// so users get fresh, real, geographically-scoped results without any third-party
...
export function getPOILinks(neighborhood, city, coords) {
  ...
  return [
    ...
    { category: 'Hotels',        icon: '🛏️', url: getGoogleMapsSearchUrl(`hotels in ${base}`,           lat, lon) },
  ];
}
